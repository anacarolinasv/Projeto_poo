...
from apresentacao.cliente.carrinho_cliente import CarrinhoClienteUI
from apresentacao.cliente.compras_cliente import ComprasClienteUI
from apresentacao.cliente.perfil_cliente import PerfilClienteUI
...
class LojaClienteUI:
    ...
    def main(usuario, carrinho):
        ...
        if pagina == "produtos":
            ...
            from apresentacao.cliente.favoritos_cliente import FavoritosClienteUI
